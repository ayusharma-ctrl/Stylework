...
export class LeadsController {
 constructor(private readonly leads:LeadsService,private readonly statuses:LeadStatusService) {}
 ...
 @Patch(':id/status') change(@Param('id',new ZodPipe(uuidSchema)) id:string,@Body(new ZodPipe(changeLeadStatusSchema)) body:ChangeLeadStatus,@Req() req:ApiRequest){return this.statuses.change(id,body,req.principal!,req.requestId);}
}
