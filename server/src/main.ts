...
export async function bootstrap() {
  ...
  app.enableCors({
    ...
    allowedHeaders: ['Content-Type', 'Authorization', 'X-Refresh-Token', 'X-Webhook-Key'],
    exposedHeaders: ['X-Request-ID', 'X-Access-Token', 'X-Access-Token-Expires-At', 'Retry-After'],
    credentials: false,
  });
